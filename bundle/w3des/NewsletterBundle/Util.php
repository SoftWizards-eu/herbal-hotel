...
class Util
{
    ...
    public function __construct(EntityManager $em, RequestStack $stack, Router $router, Settings $settings, MailerInterface $mailer, $defaultScheme, $defaultHost)
    {
    ...
    public function import($_service, $pageLocale, $fileName)
    {
